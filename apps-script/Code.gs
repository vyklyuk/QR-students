...
function handleSendCard(request) {
  ...
  var courseName = 'Інтелектуальний аналіз та візуалізація даних';
  var subject = 'QR-картка для відмітки присутності — «' + courseName + '»';
  var body =
    'Вітаємо, ' + name + '!\n\n' +
    ...
    '- Це новий сервіс, і перші заняття він працюватиме в пробному режимі — якщо щось піде не так ' +
    '(наприклад, відмітка не з\'явилась), просто повідом викладачу, все буде враховано вручну.\n\n' +
    'Гарного навчання!';
